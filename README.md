...
```
npm create cloudflare@latest -- --template=cloudflare/templates/holy-dream-4005
```

A live public deployment of this template is available at [https://holy-dream-4005.templates.workers.dev](https://holy-dream-4005.templates.workers.dev)
